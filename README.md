...
Além da programação, desenvolvi habilidades importantes trabalhando em um negócio próprio na área de delivery de pizzas:

- Organização e comunicação inteligente  
- Controle de Fluxo de caixa e gestão financeira  
- Criação e gerenciamento de planilhas (Excel)  
- Relacionamento com clientes  
- Trabalho sob pressão  

Essas habilidades me ajudam a ser um profissional mais organizado, responsável e orientado a resultados.
